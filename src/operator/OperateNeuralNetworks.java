...
import neuralnetworks.DataObject;
import neuralnetworks.ProcessingEngine;
import neuralnetworks.ReadFiles;

/**
 *
 * @author Welcome
 */
public class OperateNeuralNetworks implements Runnable{
 private static final Double THETA_LR=0.000001;
    ...
    public void run() {
      ...
      System.out.println("Pattern prediction using neural networks\n");
...
//         ProcessingEngine engine =new ProcessingEngine(theta,data.getInputs().size(),data.getInputs().get(0).size(),COST_ERROR_LR,COST_DIFFERENCE_ACCEPT_LR,LEARNING_RATE_LR,REGULARIZED_VALUE);
//        
